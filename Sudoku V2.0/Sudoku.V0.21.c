...
int main()
{
	int valid_flag = 0, exit_flag=0, i=0, j=0, dummy=0, iteration = 0, dummy1 = 0, complete_flag=0;
	initialize();
	input_sudoku();
	...
	print_sudoku();
	complete_flag = sudoku_complete();
	//Logic for permutation combinatoin
	if(complete_flag == 1)
	{
		printf("\n Sudoku complete\n");
	}
